...
function Card({ external_id, title, price, images, url, date }: CardProps) {const carouselId = `carousel-${external_id}`;
    return(
                ...
                <div className="card align-items-center rounded-5">
                    ...
                    <div className="card-body">
                        ...
                        <div className="container row" style={{padding: '0'}}>
                            ...
                            <div className="col-5">
                                <text style={{color: '#1a4013'}} className='btn btn-sm btn-success rounded-5'>
                                    отличная цена
                                </text>
                            </div>
                        </div>
